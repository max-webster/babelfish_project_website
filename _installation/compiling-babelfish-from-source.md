...
If you happen to use Debian or Ubuntu flavor, you might want to use the following
...
Before starting Babelfish, it is needed to modify the ownership of the installation and the folder
